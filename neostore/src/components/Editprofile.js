...
function Editprofile(props) {
  ...
  return (
    <div style={{ height: "444px" }} className="container-fluid" id="edit">
      {userdata.map((val, index) =>
        val.email === email ? (
          <div className="page-content page-container" id="inedit">
                    ...
                    <div className="row m-l-0 m-r-0">
                      ...
                      <div className="col-sm-8">
                        <div className="card-block row">
                          <h4
                            className="m-b-20 p-b-5 b-b-default f-w-600 col-sm-5"
                            style={{
